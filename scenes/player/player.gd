...
@onready var sfx_jump: AudioStreamPlayer = $Sound/sfx_jump
@onready var sfx_hover: AudioStreamPlayer = $Sound/sfx_hover
@onready var sfx_phase_out: AudioStreamPlayer = $Sound/sfx_phase_out
@onready var sfx_phase_in: AudioStreamPlayer = $Sound/sfx_phase_in
@onready var sfx_hover_fail: AudioStreamPlayer = $Sound/sfx_hover_fail
